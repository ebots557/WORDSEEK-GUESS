...
"""
    buttons = [
        ...
        [InlineKeyboardButton("« ɢʀᴏᴜᴘ sᴇᴛᴛɪɴɢ", callback_data="grp_set"),
         InlineKeyboardButton("ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ", callback_data="other_cmd"),
         InlineKeyboardButton("ɢɪᴛʜᴜʙ ʀᴇᴘᴏ ↗️", url="https://github.com/binamralamsal/WordSeek")]
    ]
